                            ...
                            >
                                <template v-if="!p.isPlaceholder">
                                    ...
                                    <div class="relative z-10 flex-1 flex flex-col items-start pr-6 gap-1">
                                        <h3 class="text-sm md:text-base font-black text-[#1d1d1f] dark:text-white leading-snug line-clamp-2 break-words">{{ p.name }}</h3>
                                        <span v-if="p.client" class="text-[10px] font-bold text-gray-500 dark:text-gray-400 leading-tight line-clamp-1">{{ p.client }}</span>
                                    </div>
